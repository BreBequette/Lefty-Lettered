...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-GBBXE0KBBT"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-GBBXE0KBBT');
</script>
    ...
    <form class="contact" method="post" action="<?= $_SERVER['PHP_SELF'] ?>" role="form">
     ...
     <footer>
        ...
        <div class="three-column-footer">
            ...
            <div class="column">
                <h3>Follow Me</h3> 
                Instagram: <a href="https://www.instagram.com/leftylettered/"> @leftylettered </a>
            </div>
        </div>
            
        <div class="footer-links">
            Saint Louis, MO | &copy; Breanna Bequette 2021
        </div>
